package com.black.study.contents.alarm
...
import com.black.study.databinding.FragmentAlarmBinding
...
class AlarmFragment : ContentsFragment<FragmentAlarmBinding>() {
